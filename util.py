...
class DeterministicConditional(nn.Module):
  def __init__(self, mapping, shift=None, encoder = True):
    ...
    self.cv4 = ConvTranspose2d(DIM * 2, DIM, 4, 1, 1, bias=False)
    self.cv5 = ConvTranspose2d(DIM, NUM_CHANNELS, 4, 1, 1, bias=False)
...
class ContrastiveLearningViewGenerator(object):
    ...
    def __init__(self, base_transform, n_views=2, size=32):
