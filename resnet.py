...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, h_dim=512):
        ...
        self.linear = nn.Linear(512*block.expansion, h_dim)
    ...
    def forward(self, x):
        ...
        out = F.avg_pool2d(out, 16) # Need to adapt to different image resolution # 128 -> 16; 32 -> 4
